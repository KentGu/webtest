...
import com.lombardrisk.pojo.AuditTradesReportFilter;
import com.lombardrisk.pojo.OrganisationSearch;
import com.lombardrisk.pojo.SimpleSearch;



public final class AuditTradesReportPage extends AbstractReportPage {

    public AuditTradesReportPage(IWebDriverWrapper webDriverWrapper) {
        super(webDriverWrapper);
    }
    
    public void setAuditTradesReport(AuditTradesReportFilter reportFilter) throws Exception{
    ...
    public void saveAsTemplate(AuditTradesReportFilter reportFilter) throws Exception{
