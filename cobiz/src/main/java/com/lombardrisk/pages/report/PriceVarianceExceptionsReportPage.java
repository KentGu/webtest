...
import com.lombardrisk.pojo.PriceVarianceExceptionsReportFilter;
import com.lombardrisk.pojo.SimpleSearch;


public final class PriceVarianceExceptionsReportPage extends AbstractReportPage {

    public PriceVarianceExceptionsReportPage(IWebDriverWrapper webDriverWrapper) {
        super(webDriverWrapper);
    }
    
    public void setPriceVarianceExceptionsReport(PriceVarianceExceptionsReportFilter reportFilter) throws Exception{
    	...
    	if (reportFilter.getPriceChangeGreaterThan() != null){
    		element("rp.price.change.greater.than").input(reportFilter.getPriceChangeGreaterThan().getRealValue());
    	}
    	if (reportFilter.getPriceChangePercentageGreaterThan() != null){
    		element("rp.price.change.percentage.greater.than").input(reportFilter.getPriceChangePercentageGreaterThan().getRealValue());
    	}
    ...
    public void savaAsTemplate(PriceVarianceExceptionsReportFilter reportFilter) throws Exception{
